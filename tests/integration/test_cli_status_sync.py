...
class CliStatusSyncTests(unittest.TestCase):
    ...
    def test_registry_sync_statuses_updates_all_automated_entity_sections(self) -> None:
        ...
        self.assertEqual(dry_payload["changed"], 4)
        ...
        self.assertEqual(payload["changed"], 4)

        updated = json.loads(registry_path.read_text(encoding="utf-8"))
        self.assertEqual(updated["evidence"][0]["status"], "passed")
        self.assertEqual(updated["tests"][0]["status"], "passing")
        self.assertEqual(updated["claims"][0]["status"], "asserted")
        self.assertEqual(updated["features"][0]["implementation_status"], "partial")
        ...
        self.assertEqual(updated["profiles"][0]["status"], "draft")
