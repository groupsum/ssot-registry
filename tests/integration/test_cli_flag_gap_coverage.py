...
class CliFlagGapCoverageTests(unittest.TestCase):
    def test_manifest_includes_new_body_flags(self) -> None:
        ...
        self.assertIn("--adr-ids", manifest["flags_by_path"]["spec create"])
        ...
        self.assertIn("--body", manifest["flags_by_path"]["feature create"])
        self.assertIn("--body-file", manifest["flags_by_path"]["feature create"])
        self.assertIn("--auto-scaffold-proof-graph", manifest["flags_by_path"]["feature create"])
        self.assertIn("--ids", manifest["flags_by_path"]["feature certify-proof-graph"])
        self.assertIn("--boundary-id", manifest["flags_by_path"]["feature certify-proof-graph"])
        self.assertIn("--release-id", manifest["flags_by_path"]["feature certify-proof-graph"])
        self.assertIn("--robustness-dimensions", manifest["flags_by_path"]["feature certify-proof-graph"])
        self.assertIn("--body", manifest["flags_by_path"]["feature update"])
        self.assertIn("--body-file", manifest["flags_by_path"]["feature update"])
        self.assertIn("--body", manifest["flags_by_path"]["test create"])
        self.assertIn("--body-file", manifest["flags_by_path"]["test create"])
        self.assertIn("--body", manifest["flags_by_path"]["test update"])
        self.assertIn("--body-file", manifest["flags_by_path"]["test update"])
        self.assertIn("--robustness-dimensions", manifest["flags_by_path"]["evidence create"])
        self.assertIn("--source-evidence-ids", manifest["flags_by_path"]["evidence create"])
        self.assertIn("--release-context-json", manifest["flags_by_path"]["evidence create"])
        self.assertIn("--release-context-file", manifest["flags_by_path"]["evidence update"])
        self.assertIn("--body-file", manifest["flags_by_path"]["issue create"])
        self.assertIn("--body-file", manifest["flags_by_path"]["issue update"])
        self.assertIn("--body-file", manifest["flags_by_path"]["boundary create"])
        self.assertIn("--body-file", manifest["flags_by_path"]["boundary update"])
        self.assertIn("--body-file", manifest["flags_by_path"]["profile create"])
        self.assertIn("--body-file", manifest["flags_by_path"]["profile update"])
        self.assertIn("--body-file", manifest["flags_by_path"]["release create"])
        self.assertIn("--body-file", manifest["flags_by_path"]["release update"])
