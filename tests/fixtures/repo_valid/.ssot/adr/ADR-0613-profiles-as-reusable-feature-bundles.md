# ADR-0613: Profiles are reusable feature bundles with derived pass status
...
- reusable capability and certification bundles become explicit and composable,
- release and validation surfaces can report profile-level results,
- boundaries remain canonical for freeze/release semantics,
- no write-time expansion of boundary features from profiles.
