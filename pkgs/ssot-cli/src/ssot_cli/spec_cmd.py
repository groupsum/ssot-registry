...
def register_spec(subparsers: argparse._SubParsersAction) -> None:
    ...
    create.add_argument("--kind", choices=["normative", "operational", "governance", "local-policy"], default="local-policy")
    ...
    update = spec_sub.add_parser("update", help="Update a spec.")
    add_path_argument(update)
    update.add_argument("--id", required=True)
    update.add_argument("--title", default=None)
    update.add_argument("--body-file", default=None)
    update.add_argument("--kind", choices=["normative", "operational", "governance", "local-policy"], default=None)
